# Generated by Django 4.2.1 on 2023-08-13 18:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('women', 'женщина'), ('men', 'мужчина')], max_length=10, verbose_name='Пол')),
                ('tel', models.CharField(max_length=12, verbose_name='Телефон')),
                ('status', models.CharField(choices=[('In_active', 'В активном поиске'), ('Relationship', 'В отношениях'), ('Communication', 'Только Общение')], max_length=20, verbose_name='Статус')),
